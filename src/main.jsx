...
function displayTitle(name){
  ...
  s=s.replace(/\[[^\]]*\]/g,' ').replace(DISPLAY_NOISE,' ').replace(/[|_]+/g,' ').replace(/\s{2,}/g,' ').replace(/^[\s\-–.:]+|[\s\-–.:]+$/g,'').trim();
